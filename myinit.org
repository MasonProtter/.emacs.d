...
(setq julia-snail-executable "~/julia/./julia")
...
(general-define-key
 ...
 "C-c C-l" 'julia-snail-copy-repl-region)
...
(defun org-babel-execute:julia (body params)
  (let ((src-file (org-babel-temp-file "julia-src-"))
	...
	(org-babel-julia-evaluate body src-file out-file)
	(let ((c 0))
...
(defun org-babel-julia-evaluate (body src-file out-file)
...
begin
    ...
    println(read(var\"#out_file#\", String))
end"
					   out-file src-file)))
    ;; (julia-snail--send-to-repl text)
